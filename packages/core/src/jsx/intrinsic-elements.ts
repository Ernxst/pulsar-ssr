// Users might not specify "dom" in their lib in tsconfig.json
/// <reference lib="dom" />
...
declare global {
	namespace Pulsar {
		...
		export interface DOMAttributes<T extends EventTarget> {
			...
			onoutrostartcapture?:
				| EventHandler<CustomEvent<null>, T>
				| undefined
				| null;
		...
		export interface PulsarMediaTimeRange {
			start: number;
			end: number;
		}

		export interface PulsarDocumentAttributes
			extends HTMLAttributes<Document> {}

		export interface PulsarWindowAttributes extends HTMLAttributes<Window> {
			...
			onbeforeunload?:
				| EventHandler<BeforeUnloadEvent, Window>
				| undefined
				| null;
			...
			ondeviceorientation?:
				| EventHandler<DeviceOrientationEvent, Window>
				| undefined
				| null;
			...
			onunhandledrejection?:
				| EventHandler<PromiseRejectionEvent, Window>
				| undefined
				| null;
		...
		export interface IntrinsicElements {
			...
			media: HTMLMediaAttributes<HTMLMediaElement>;
...
export interface IntrinsicElements extends Pulsar.IntrinsicElements {}
